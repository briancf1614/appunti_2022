...
/*
Testo del problema
Dati in input il prezzo e la quantit? di un certo prodotto, determinare la fascia di sconto da applicare e stampare i dati inseriti, la percentuale di sconto applicata, lo sconto effettuato e il totale da pagare.
...
int main(){
	...
	int quantita; //quantit? del prodotto
